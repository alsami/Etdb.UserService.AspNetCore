using Autofac;
using EntertainmentDatabase.REST.API.AuthService.Bootstrap.Config;
using EntertainmentDatabase.REST.API.AuthService.Bootstrap.Validators;
using EntertainmentDatabase.REST.API.Data;
...
namespace EntertainmentDatabase.REST.API.AuthService.Bootstrap
{
